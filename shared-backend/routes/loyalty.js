...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'loyalty'} service is running`,
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'loyalty'} item retrieved`,
...
router.get('/search', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'loyalty'} search results`,
