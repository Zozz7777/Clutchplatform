...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'mobile-cms'} service is running`,
    timestamp: new Date().toISOString(),
    method: 'GET',
    path: '/'
  });
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'mobile-cms'} item retrieved`,
...
router.post('/', (req, res) => {
  res.status(201).json({
    success: true,
    message: `${'mobile-cms'} item created`,
...
router.put('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'mobile-cms'} item updated`,
...
router.delete('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'mobile-cms'} item deleted`,
...
router.get('/search', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'mobile-cms'} search results`,
