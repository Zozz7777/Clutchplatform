...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'disputes'} service is running`,
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'disputes'} item retrieved`,
...
router.get('/search', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'disputes'} search results`,
