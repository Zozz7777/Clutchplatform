...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'system'} service is running`,
    timestamp: new Date().toISOString(),
    method: 'GET',
    path: '/'
  });
