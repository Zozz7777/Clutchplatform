...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'partners'} service is running`,
    timestamp: new Date().toISOString(),
    method: 'GET',
    path: '/'
  });
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'partners'} item retrieved`,
