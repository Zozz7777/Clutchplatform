...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'services'} service is running`,
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'services'} item retrieved`,
