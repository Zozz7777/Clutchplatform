...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'payouts'} service is running`,
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'payouts'} item retrieved`,
...
router.get('/search', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'payouts'} search results`,
