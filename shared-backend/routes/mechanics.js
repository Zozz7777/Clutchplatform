...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'mechanics'} service is running`,
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'mechanics'} item retrieved`,
...
router.post('/', (req, res) => {
  res.status(201).json({
    success: true,
    message: `${'mechanics'} item created`,
...
router.put('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'mechanics'} item updated`,
...
router.delete('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'mechanics'} item deleted`,
...
router.get('/search', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'mechanics'} search results`,
