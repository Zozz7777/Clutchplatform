...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'mobile'} service is running`,
    timestamp: new Date().toISOString(),
    method: 'GET',
    path: '/'
  });
