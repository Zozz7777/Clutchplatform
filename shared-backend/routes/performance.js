...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'performance'} service is running`,
    timestamp: new Date().toISOString(),
    method: 'GET',
    path: '/'
  });
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'performance'} item retrieved`,
...
router.post('/', (req, res) => {
  res.status(201).json({
    success: true,
    message: `${'performance'} item created`,
...
router.put('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'performance'} item updated`,
...
router.delete('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'performance'} item deleted`,
...
router.get('/search', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'performance'} search results`,
