...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'tradeIn'} service is running`,
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'tradeIn'} item retrieved`,
...
router.get('/search', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'tradeIn'} search results`,
