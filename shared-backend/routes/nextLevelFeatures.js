...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'nextLevelFeatures'} service is running`,
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'nextLevelFeatures'} item retrieved`,
...
router.post('/', (req, res) => {
  res.status(201).json({
    success: true,
    message: `${'nextLevelFeatures'} item created`,
...
router.put('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'nextLevelFeatures'} item updated`,
...
router.delete('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'nextLevelFeatures'} item deleted`,
...
router.get('/search', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'nextLevelFeatures'} search results`,
