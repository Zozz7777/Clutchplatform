...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'vehicles'} service is running`,
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'vehicles'} item retrieved`,
