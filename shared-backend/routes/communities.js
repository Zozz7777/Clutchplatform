...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'communities'} service is running`,
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'communities'} item retrieved`,
...
router.post('/', (req, res) => {
  res.status(201).json({
    success: true,
    message: `${'communities'} item created`,
...
router.put('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'communities'} item updated`,
...
router.delete('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'communities'} item deleted`,
