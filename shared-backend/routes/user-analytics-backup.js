...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'user-analytics-backup'} service is running`,
    timestamp: new Date().toISOString(),
    method: 'GET',
    path: '/'
  });
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'user-analytics-backup'} item retrieved`,
...
router.post('/', (req, res) => {
  res.status(201).json({
    success: true,
    message: `${'user-analytics-backup'} item created`,
...
router.put('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'user-analytics-backup'} item updated`,
...
router.delete('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'user-analytics-backup'} item deleted`,
...
router.get('/search', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'user-analytics-backup'} search results`,
