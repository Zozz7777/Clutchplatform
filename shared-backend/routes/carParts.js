...
router.get('/', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'carParts'} service is running`,
    timestamp: new Date().toISOString(),
    method: 'GET',
    path: '/'
  });
...
router.get('/:id', (req, res) => {
  ...
  res.status(200).json({
    success: true,
    message: `${'carParts'} item retrieved`,
...
router.get('/search', (req, res) => {
  res.status(200).json({
    success: true,
    message: `${'carParts'} search results`,
