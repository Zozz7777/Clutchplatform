...
import com.clutch.app.utils.AuthInterceptor
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideClutchApiService(retrofit: Retrofit): ClutchApiService {
        return retrofit.create(ClutchApiService::class.java)
    }
}
