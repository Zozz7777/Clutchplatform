...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-[0.625rem] text-sm font-medium transition-all duration-normal ease-in-out disabled:pointer-events-none disabled:opacity-50 font-sans focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        sm: "h-9 rounded-[0.625rem] px-3 text-sm",
