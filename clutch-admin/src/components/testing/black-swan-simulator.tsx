...
export default function BlackSwanSimulator({ className }: BlackSwanSimulatorProps) {
  ...
  useEffect(() => {
    const loadBlackSwanData = () => {
      const mockBlackSwanEvents: BlackSwanEvent[] = [
        {
          id: 'event-001',
          name: 'Global Cyber Attack',
          description: 'Coordinated cyber attack targeting critical infrastructure and financial systems',
          ...
          scenarios: [
            {
              ...
              mitigation: [
                {
                  strategy: 'Backup system activation',
                  effectiveness: 85,
                  cost: 500000,
                  timeToImplement: 12
                },
            ...
            },
            {
              ...
              mitigation: [
                {
                  strategy: 'Immediate data encryption',
                  effectiveness: 95,
                  cost: 800000,
                  timeToImplement: 8
                },
                {
                  strategy: 'Regulatory compliance response',
                  effectiveness: 60,
                  cost: 400000,
                  timeToImplement: 24
                }
          ...
          triggers: [
            {
              condition: 'unusual_network_traffic > 500%',
              threshold: 500,
              metric: 'network_traffic'
            },
            {
              condition: 'failed_login_attempts > 1000/hour',
              threshold: 1000,
              metric: 'failed_logins'
            },
            {
              condition: 'data_exfiltration_rate > 1GB/hour',
              threshold: 1,
          ...
          resilience: {
            ...
            gaps: [
              ...
              'Inadequate incident response team'
            ]
          },
          lastSimulated: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
          nextSimulation: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString()
        },
        {
          id: 'event-002',
          name: 'Natural Disaster - Earthquake',
          description: 'Major earthquake affecting multiple data centers and infrastructure',
          ...
          scenarios: [
            {
              ...
              mitigation: [
                {
                  strategy: 'Geographic redundancy activation',
                  effectiveness: 95,
                  cost: 1000000,
                  timeToImplement: 24
                },
                {
                  strategy: 'Cloud backup restoration',
                  effectiveness: 85,
                  cost: 500000,
                  timeToImplement: 48
                }
            ...
            },
            {
              ...
              mitigation: [
                {
                  strategy: 'Backup power systems',
                  effectiveness: 90,
                  cost: 300000,
                  timeToImplement: 12
                },
                {
                  strategy: 'Generator deployment',
                  effectiveness: 75,
                  cost: 200000,
                  timeToImplement: 18
                }
            ...
            {
              id: 'scenario-3',
              name: 'Network Infrastructure Damage',
              probability: 20,
              impact: {
                users: 100000,
                revenue: 600000,
              ...
              mitigation: [
                {
                  strategy: 'Satellite communication backup',
                  effectiveness: 80,
                  cost: 400000,
                  timeToImplement: 36
                },
                {
                  strategy: 'Mobile network routing',
                  effectiveness: 70,
                  cost: 150000,
                  timeToImplement: 24
                }
          ...
          triggers: [
            {
              condition: 'seismic_activity > 6.0 magnitude',
              threshold: 6.0,
              metric: 'seismic_activity'
            },
            {
              condition: 'power_outage_duration > 2 hours',
              threshold: 2,
              metric: 'power_outage'
            },
            {
              condition: 'network_latency > 5000ms',
              threshold: 5000,
          ...
          lastSimulated: new Date(Date.now() - 14 * 24 * 60 * 60 * 1000).toISOString(),
          nextSimulation: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000).toISOString()
        },
        {
          id: 'event-003',
          name: 'Economic Crisis',
          description: 'Global economic downturn affecting customer spending and business operations',
          ...
          scenarios: [
            ...
            },
            {
              ...
              mitigation: [
                {
                  strategy: 'Alternative vendor sourcing',
                  effectiveness: 80,
                  cost: 500000,
                  timeToImplement: 45
                },
                {
                  strategy: 'Payment term renegotiation',
                  effectiveness: 65,
                  cost: 100000,
                  timeToImplement: 21
                }
          ...
          triggers: [
            {
              condition: 'customer_churn_rate > 15%',
              threshold: 15,
            ...
            {
              condition: 'payment_delays > 30 days',
              threshold: 30,
          ...
          resilience: {
            ...
            target: 80,
            gaps: [
              'Limited customer retention programs',
              'Insufficient vendor diversification',
              'Inadequate financial contingency planning'
            ]
          },
          lastSimulated: new Date(Date.now() - 21 * 24 * 60 * 60 * 1000).toISOString(),
          nextSimulation: new Date(Date.now() + 21 * 24 * 60 * 60 * 1000).toISOString()
        }
      ];

      setBlackSwanEvents(mockBlackSwanEvents);
      setSelectedEvent(mockBlackSwanEvents[0]);
    };
