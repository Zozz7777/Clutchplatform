          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {highPriorityForecasts.slice(0, 3).map((forecast) => (
                <div key={forecast.vehicleId} className="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-200">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2 max-h-64 overflow-y-auto">
            {filteredForecasts.map((forecast) => (
              <div key={forecast.vehicleId} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-3">
