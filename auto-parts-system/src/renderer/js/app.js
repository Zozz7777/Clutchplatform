...
// Modules are loaded as scripts, so they're available globally

// Import all managers at the top level
const signinManager = require('./signin-manager');
const dashboardManager = require('./dashboard-manager');
const inventoryManager = require('./inventory-manager');
const importManager = require('./import-manager');
const salesManager = require('./sales-manager');
const customerManager = require('./customer-manager');
const supplierManager = require('./supplier-manager');
const aiInsightsManager = require('./ai-insights-manager');
const reportsManager = require('./reports-manager');
const deploymentManager = require('./deployment-manager');
const connectionStatusManager = require('./connection-status-manager');
