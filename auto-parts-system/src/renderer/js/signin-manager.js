...
class SignInManager {
        ...
        try {
            ...
            if (isValid) {
                ...
                if (window.apiManager) {
                    window.apiManager.apiKey = credentials.apiKey;
                    window.apiManager.shopId = credentials.shopId;
                }

                // Show success message
                uiManager.showNotification('تم تسجيل الدخول بنجاح', 'success');
                ...
                uiManager.showNotification('خطأ في بيانات الدخول', 'error');
            }

        } catch (error) {
            console.error('Sign in error:', error);
            uiManager.showNotification('خطأ في تسجيل الدخول', 'error');
        } finally {
            this.hideLoading();
        }
    }
    ...
    signOut() {
        ...
        uiManager.showNotification('تم تسجيل الخروج بنجاح', 'info');
    }
